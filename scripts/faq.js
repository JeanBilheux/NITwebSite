$(document).ready(function() {
	...
	$('div ul li').click(function() {
		...
		{
			case 'categorie1_#1':
			$answer_value = 'The <a href="team.php"><span id="link">instrument scientist</span></a> is the person you should contact to get first to verify that neutrons are suited for your application and he/she can help in writing your proposal.';
			break;
			case 'categorie1_#2':
			...
			'<p>If you need fast access or are trying to do a proof-of-concept measurements (a few hours of beam time), please contact the <a href="team.php"><span id="link">instrument scientist</span></a>.</p>';
			break;
			case 'categorie2_#1':
			...
			'Before you are allowed to operate the facility (shutter, equipment, etc.), <a href="team.php"><span id="link">the instrument team</span></a> will give you an additional training.';
			break;
			case 'categorie2_#2':
			$answer_value = 'Your data is located on a server at HFIR and the <a href="team.php"><span id="link">beam staff</span></a> will provide information on how to access it on and off site.';
			break;
			case 'categorie2_#3':
			$answer_value = 'Access to our capabilities is obtained via a <a href="http://neutrons.ornl.gov/users/become.shtml#register"><span id="link">user proposal</span></a>. For proprietary research, please contact the <a href="team.php"><span id="link">instrument scientist</span></a>.';
			break;
			case 'categorie2_#4':
			...
			break;
			case 'categorie3_#2':
			$answer_value = '<a href="team.php"><span id="link">The instrument team</span></a> is available to help you at any time. Please make sure that you bring the appropriate level of support to make sure you are utilizing the facility 24/7.';
			break;
			case 'categorie3_#3':
			...
			break;
			case 'categorie4_#1':
			$answer_value = '<a href="team.php"><span id="link">The instrument staff</span></a> will make every effort to reconstruct your sample(s) in 3D. If you are familiar with tomography and would prefer to do this yourself, let the <a href="team.php"><span id="link">the beam staff</span></a> know.';
			break;
		}
